...
const MainSection = props => {
	const showResume = () => {
		console.clear();
		console.group('resume is now available. This is a temporary resume and will be removed soon. Thanks for visiting.');
		// setTimeout(() => {
	...
	return (
		<div className={`main-home ${props.theme}`}>
			<div className='main-home-section'>
				...
				<p>Welcome to this website. This website is portfolio of mine Here you can know about me in breif Scroll Up To know more about me.</p>
				<div>
